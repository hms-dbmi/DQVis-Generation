...
def generate():
    ...
    df = add_row(
        ...
        tasks="Compare counts across categories from a related entity; discover cross-entity distribution patterns.",
    ...
    df = add_row(
        df,
        query_template=f"What is the proportion of <F1:n> for each <F2:n>?",
        spec=(
            Chart()
            .source("<E>", "<E.url>")
    ...
    df = add_row(
        ...
        design_considerations="Groups by the nominal field and counts occurrences. In-cell bars provide visual proportion comparison. Limits to fields with fewer than 50 categories.",
